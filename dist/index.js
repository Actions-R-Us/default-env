            ...
            try {
                for (_i = 0, env_vars_1 = env_vars; _i < env_vars_1.length; _i++) {
                    ...
                    if (env_var in process.env) {
                        _actions_core__WEBPACK_IMPORTED_MODULE_0__.debug("Export: " + env_var + "=" + process.env[env_var]);
                        _actions_core__WEBPACK_IMPORTED_MODULE_0__.exportVariable(env_var, process.env[env_var]);
                    }
                }
            }
            catch (error) {
